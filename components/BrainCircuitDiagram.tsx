...
const regionsData: BrainRegion[] = [
  { id: 'pfc', name: '전전두피질 (Prefrontal Cortex)', abbreviation: 'PFC', x: 200, y: 150, radius: 60 },
  { id: 'sef', name: '보조안구영역 (Supplementary Eye Fields)', abbreviation: 'SEF', x: 150, y: 200, radius: 45 },
  { id: 'fef', name: '전두안구영역 (Frontal Eye Fields)', abbreviation: 'FEF', x: 250, y: 220, radius: 50 },
  { id: 'pef', name: '두정안구영역 (Parietal Eye Fields / PPC)', abbreviation: 'PEF/PPC', x: 450, y: 180, radius: 55 },
  { id: 'sc', name: '상구 (Superior Colliculus)', abbreviation: 'SC', x: 350, y: 450, radius: 50 },
  { id: 'bg', name: '기저핵 (Basal Ganglia)', abbreviation: 'BG', x: 250, y: 350, radius: 45 },
];
